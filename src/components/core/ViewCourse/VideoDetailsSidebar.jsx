...
export default function VideoDetailsSidebar({ setReviewModal }) {
  ...
  useEffect(() => {
    (() => {
      ...
      setActiveStatus(courseSectionData?.[currentSectionIndx]?._id);  //marked active section
      setVideoBarActive(activeSubSectionId); //marked active subsection
    })();
                    ...
                    <div className="transition-[height] duration-500 ease-in-out">
                      {course.subSection.map((topic, i) => (
                        <div
                          ...
                          onClick={() => {
                            navigate(
                              `/view-course/${courseEntireData?._id}/section/${course?._id}/sub-section/${topic?._id}` // show the video
                            );
                            setVideoBarActive(topic._id);  //mark the curr video
                          }}
                        >
                          <input
                            type="checkbox"
